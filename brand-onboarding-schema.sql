-- Brand Onboarding Database Schema
...
CREATE TABLE IF NOT EXISTS brands (
  ...
  phone text,
  address text,
  broker_name text,               -- admin intelligence
  broker_agreement text,          -- admin intelligence
  nda_status text,                -- admin intelligence
  data_source text,               -- 'client_supplied' or 'admin_added' or 'public'
  data_confidence text,           -- 'high','medium','low'
  visibility jsonb DEFAULT '{}'::jsonb,   -- field level visibility map
